        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-slate-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('sku') border-red-500 @enderror"
                />
                @error('sku')
                    <p class="mt-1 text-sm text-red-500 flex items-center">
                        <span class="mr-1">❌</span> {{ $message }}
